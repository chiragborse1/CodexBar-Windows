...
- `Sources/CodexBarCore/Providers/Windsurf/WindsurfProviderImplementation.swift` (settings UI)
- `Sources/CodexBarCore/Providers/Windsurf/WindsurfSettingsStore.swift` (settings persistence)
